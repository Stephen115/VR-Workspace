...
namespace TextureSharing
{
    ...
    {
        [SerializeField]
        int messagePerSecond = 30; // 100 Messages / Second
        ...
        public VdmDesktop getTexture;

        void Start()
        {
            Invoke("FindTexture", .3f);
            //getTexture = GetComponent<VdmDesktop>();
