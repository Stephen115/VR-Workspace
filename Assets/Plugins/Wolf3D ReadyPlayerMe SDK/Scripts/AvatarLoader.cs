...
namespace Wolf3D.ReadyPlayerMe.AvatarSDK
{
    ...
    public class AvatarLoader
    {
        ...
        public string SaveFolder { get; set; } = "Resources";
        ...
        private const string MaleAnimatorControllerName = "AnimationControllers/MaleFullbody";
        private const string FemaleAnimatorControllerName = "AnimationControllers/FemaleFullbody";
        ...
        {
            #if UNITY_EDITOR
                AssetDatabase.ImportAsset("Assets/Resources/" + uri.ModelName);
            #endif
