...
{
    [BurstCompile]
    public struct PlayerDataGhostComponentSerializer
    {
        static GhostComponentSerializer.State GetState()
        {
            ...
            if (!s_StateInitialized)
            {
                s_State = new GhostComponentSerializer.State
                {
                    ...
                    ComponentType = ComponentType.ReadWrite<PlayerData>(),
                    ComponentSize = UnsafeUtility.SizeOf<PlayerData>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<PlayerData>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<PlayerData>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<PlayerData>(backupData, 0);
